...
with one:
    ...
    with col1:
        blog_post(
            blog_title="How to integrate ChatGPT with Python?",
            blog_link="https://medium.com/@gowtham180502/how-to-integrate-chatgpt-with-python-7dc61d471d8d",
            blog_caption="In this article, we are going to discuss how to integrate ChatGPT with Python. Before that, we have to know what actually a ChatGPT is. We will discuss that in the following,"
        )
    with col2:
        blog_post(
            blog_title="How to deploy your CNN model in IBM Cloud?",
            blog_link="https://medium.com/@gowtham180502/how-to-deploy-your-cnn-model-in-ibm-cloud-19d49e4d0cf8",
            blog_caption="This article clearly explains how to deploy your Convolutional Neural Network (CNN) model in IBM Cloud platform."
        )
    with col3:
        blog_post(
...
with three:
    ...
    with col2:
        blog_post(
            blog_title="Implementing RSA Algorithm using Python",
            blog_link="https://medium.com/@gowtham180502/implementing-rsa-algorithm-using-python-836f7da2a8e0",
            blog_caption="This article explains what actually the RSA algorithm is in cryptography and shows how to implement the RSA algorithm for the encryption and decryption of data using Python. Here, data refers to numbers. You can also use string data for encryption and decryption using this algorithm."
        )
    with col3:
        blog_post(
