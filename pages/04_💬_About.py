...
with col2:
    st.markdown(
        ...
        <p style="font-size: 18px">
            ...
            📌 Currently, I did my <b>Bachelor's Degree</b>(Computer Science & Engineering) in <b>The Kavery Engineering College</b>, Salem(Dt) with the CGPA of <b>8.54</b><br>
            📌 I love programming in <b>Python</b>. After I got clear in the basics of Python, I moved to work with <b>Computer Vision</b> and I have completed a couple of projects with that.<br> 
